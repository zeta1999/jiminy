        ...
        void visit(PyClass& cl) const
        {
            cl
                ...
                .add_property("position_fieldnames", bp::make_function(&Model::getPositionFieldNames,
                                                     bp::return_value_policy<bp::copy_const_reference>()))
                .add_property("position_lower_limit", bp::make_function(&Model::getLowerPositionLimit,
                                                      bp::return_value_policy<bp::copy_const_reference>()))
                .add_property("position_upper_limit", bp::make_function(&Model::getUpperPositionLimit,
                                                      bp::return_value_policy<bp::copy_const_reference>()))
